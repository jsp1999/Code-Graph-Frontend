...
export const CollideForceScrubber: React.FC<ScrubberProps> = ({
    scrubberValue,
    onScrubberChange, }) => {
...
export const CenterForceScrubber: React.FC<ScrubberProps> = ({
    scrubberValue,
    onScrubberChange, }) => {
    const handleScrubberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const value = parseInt(e.target.value, 10);
...
export const AttractionForceScrubber: React.FC<ScrubberProps> = ({
    scrubberValue,
    onScrubberChange, }) => {
    const handleScrubberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const value = parseInt(e.target.value, 10);
